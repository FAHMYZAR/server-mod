    ...
    <div class="col-lg-6">
        ...
        <?php if (session()->getFlashdata('user_key')) : ?>
            <div class="alert alert-success" role="alert">
                ...
                License : <strong class="key-sensi"><br><?= session()->getFlashdata('result_key') ?></strong><br>
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <?php endif; ?>
                                   ...
                                   <label for="bulkkey" class="form-label">Bulk Keys</label>         
...
<script>
    $(document).ready(function() {
        ...
        getPrice(price);
        // When selected
        $("#max_devices, #duration, #game, [name='loopcount']").change(function() {
            getPrice(price);
        });
        // try to get price
        function getPrice(price) {
            ...
            var loopCount = $("[name='loopcount']").val();
            var multiplier;
            ...
            var gprice = price[duration];
            if (!isNaN(gprice)) {
                var result = (device * gprice) * multiplier;
