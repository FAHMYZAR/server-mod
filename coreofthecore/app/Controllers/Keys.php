...
class Keys extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->duration = [
            1 => '1 Day &mdash; $0.3/Device',
            3 => '3 Day &mdash; $0.5/Device',
            7 => '7 Days &mdash; $2/Device',
            14 => '14 Days &mdash; $4/Device',
            30 => '30 Days &mdash; $7/Device',
            60 => '60 Days &mdash; $14/Device',
        ];
...
private function generate_action()
{
    ...
    $validation = Services::validation();
    $reduceCheck = ($user->saldo - ($getPrice * $loopcount));
    ...
    if ($reduceCheck < 0) {
        ...
        if (!$this->validate($form_rules)) {
            ...
            for ($i = 0; $i < $loopcount; $i++) {
                ...
                $result_key .= $license . "<br>";
                session()->setFlashdata('result_key', $result_key);
                $data .= $license . "\n";
            ...
            $history->insert([
                ...
                'info' => "$game|" . substr($data, 0, 5) . "|$drtn|$maxd"
            ]);

            $other_response = [
                'fees' => $getPrice * $loopcount
            ];
